...
public class ArcLength extends CalculusApplet{

	public void init(){
		setup( "The Length of a Curve" );
		...
		contentpane.add( "Center", graph = new ArcLengthGraph( this, F, A, B, N ) );
		...
		splash = new SplashPanel( new ArcLengthGraph(this,F,A,B,N) );
