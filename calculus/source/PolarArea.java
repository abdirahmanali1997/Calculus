...
public class PolarArea extends PolarApplet{
		
	public void init(){
		setup( "The Area Bounded by a Polar Curve" );
		...
		graph = new PolarAreaGraph( this, F, A, B, N );
		rtheta = new Graph();
			rtheta.radians = true;
			rtheta.xlabel = "t";
			rtheta.ylabel = "r(t)";
		...
		splash = new SplashPanel( new PolarAreaGraph(this,F,A,B,N ) );
