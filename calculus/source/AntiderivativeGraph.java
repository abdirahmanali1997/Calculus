...
public class AntiderivativeGraph extends Graph{

	
	public AntiderivativeGraph( CalculusApplet applet, String f, String g, double a, double b ){
		super();
	...
	public void drawFunction( Graphics2D g ){
		drawFunction( g, G, Color.gray );
	}

	
	// draw slope field, not grid lines
