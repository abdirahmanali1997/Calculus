...
public class Area extends CalculusApplet{

	public void init(){
		setup( "Riemann Sums and the Area Under a Curve" );
		...
		contentpane.add( "Center", graph = new AreaGraph( this, F, A, B, N ) );
		...
		graph.repaint();
		splash = new SplashPanel( new AreaGraph(this,F,A,B,N) );
