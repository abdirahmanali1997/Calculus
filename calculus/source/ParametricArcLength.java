...
public class ParametricArcLength extends ParametricApplet{

	public void init(){
		setup( "The Length of a Parametric Curve" );
		...
		graph = new ParametricArcLengthGraph( this, F, G, A, B, N );
		xoftee = new Graph();
			xoftee.xlabel = "t";
			xoftee.ylabel = "x(t)";
			xoftee.variable = "t";
		...
		splash = new SplashPanel( new ParametricArcLengthGraph(this,F,G,A,B,N ) );
