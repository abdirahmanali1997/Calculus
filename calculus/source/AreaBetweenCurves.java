...
public class AreaBetweenCurves extends CalculusApplet{

	
	public void init(){
		setup( "Area Between Curves" );
		...
		contentpane.add( "Center", graph = new AreaBetweenCurvesGraph( this, F, G, A, B, N ) );
		...
		splash = new SplashPanel( new AreaBetweenCurvesGraph(this,F,G,A,B,N) );
