...
public class VolumeViaWashers extends CalculusApplet{
	
	public void init(){
		setup( "Volumes of Solids Generated by Rotation: Washer Method" );		
		...
		contentpane.add( "Center", graph = new VolumeViaWashersGraph( this, F, G, A, B, C, N ) );
		...
		splash = new SplashPanel( new VolumeViaWashersGraph(this,F,G,A,B,C,N ) );
