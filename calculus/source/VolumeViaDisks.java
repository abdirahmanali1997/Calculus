...
public class VolumeViaDisks extends CalculusApplet{
	
	public void init(){
		setup( "Volumes of Solids Generated by Rotation: Disk Method" );		
		...
		contentpane.add( "Center", graph = new VolumeViaDisksGraph( this, F, A, B, C, N ) );
		...
		splash = new SplashPanel( new VolumeViaDisksGraph(this,F,A,B,C,N ) );
